...
public class TankerTruck implements Truck {
     ...
     * @see #TankerTruck(Point3D, Point3D, double, double, double)
     */
    ...
    /**
     * Load goods to the tanker truck by the given amount.
     * @param amount the quantity for loading
     * @throws InvalidDataException if the amount is negative or exceeds the load limitation.
    ...
    /**
     * Unload goods from the tanker truck by the given amount.
    ...
    public void unLoad(double amount) throws InvalidDataException, CannotFitException {
     ...
     /**
     * Check whether the tanker truck is at destination.
     * @return True if the tanker truck is at destination; otherwise, return false.
     */
    @Override
    ...
    /**
     * Get the destination of this tanker truck.
    ...
    /**
     * Get the maximum speed of this tanker truck.
    ...
    /**
     * Get the speed of this tanker truck.
    ...
    /**
     * Set the destination of this tanker truck with the specified xyz coordinates.
    ...
    /**
     * Set the maximum speed of this tanker truck.
    ...
    /**
     * Get the location of the tanker truck.
     * @return the Point3D containing the  x y z data
     */
    @Override
    ...
    /**
     * Get the identifier of this tanker truck.
    ...
    /**
     * Update the location after this tanker truck moving for given time.
    ...
    /**
     * Returns a string representation of this tanker truck. 
