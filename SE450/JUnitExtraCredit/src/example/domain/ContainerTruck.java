...
public class ContainerTruck implements Truck {
    ...
    /**
     * Constructs and initializes a ContainerTruck with specified xyz coordinates of location and destination.
     ...
     * @throws InvalidDataException if the input parameters are invalid to construct a new ContainerTruck.
     * @see #ContainerTruck(Point3D, Point3D, double, double, double)
     */
    ...
    /**
     * Constructs and initializes a ContainerTruck with specified location and destination Point3D.
     ...
     * @param mlw the maximum load weight
     * @throws InvalidDataException if the input parameters are invalid to construct a new ContainerTruck.
     * @see #ContainerTruck(double, double, double, double, double, double, double, double, double)
     */
    ...
    /**
     * Check whether the required load amount is valid.
     * @param amount the quantity for loading
     * @throws InvalidDataException if the amount is not equal to the maximum load weight.
     */
    ...
    /**
     * Load goods to the container truck by the given amount.
     * @param amount the quantity for loading
     * @throws InvalidDataException if the amount is not equal to the maximum load weight.
    ...
    /**
     * Unload goods from the container truck by the given amount.
    ...
    /**
     * Check whether the container truck is at destination.
     * @return True if the container truck is at destination; otherwise, return false.
     */
    @Override
    ...
    /**
     * Get the destination of this container truck.
    ...
    /**
     * Get the maximum speed of this container truck.
    ...
    /**
     * Get the speed of this container truck.
    ...
    public double getSpeed() {
     ...
     /**
     * Set the destination of this container truck with the specified xyz coordinates.
    ...
    /**
     * Set the maximum speed of this container truck.
    ...
    /**
     * Get the location of the container truck.
     * @return the Point3D containing the  x y z data
     */
    @Override
    ...
    /**
     * Get the identifier of this container truck.
    ...
    /**
     * Update the location after this container truck moving for given time.
    ...
    /**
     * Returns a string representation of this container truck. 
     * @return information of the container truck
     */
    @Override
