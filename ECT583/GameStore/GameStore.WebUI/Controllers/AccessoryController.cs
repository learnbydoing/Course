...
namespace GameStore.WebUI.Controllers
{
    public class AccessoryController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (System.Web.HttpContext.Current.Cache["ProductList2"] != null)
            {
                list = (List<ProductDTO>)System.Web.HttpContext.Current.Cache["ProductList2"];
            }
            else
            {
                using (GameStoreDBContext context = new GameStoreDBContext())
                {
                    ...
                    list = query.ToList();
                    System.Web.HttpContext.Current.Cache["ProductList2"] = list;
                }
            }
