...
namespace GameStore.WebUI.Controllers
{
    public class GameController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (System.Web.HttpContext.Current.Cache["ProductList3"] != null)
            {
                list = (List<ProductDTO>)System.Web.HttpContext.Current.Cache["ProductList3"];
            }
            else
            {
                using (GameStoreDBContext context = new GameStoreDBContext())
                {
                    ...
                    list = query.ToList();
                    System.Web.HttpContext.Current.Cache["ProductList3"] = list;
                }
            }
