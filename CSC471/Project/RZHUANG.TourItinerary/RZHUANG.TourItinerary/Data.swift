...
class City {
    ...
    init(country: String, key: String, name: String, image: String, latitude: Double, longitude: Double, area: String, founded: String, localtime: String, weather: String, population: String, title: String, description: String) {
        self.country = country
        self.key = key
        self.name = name
        self.image = image
